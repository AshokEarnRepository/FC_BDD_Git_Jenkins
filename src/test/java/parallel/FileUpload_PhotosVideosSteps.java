...
public class FileUpload_PhotosVideosSteps {
    ...
    private String folderName = generateRandomFolderName();
...
//    }
    ...
    public void user_enters_the_folder_name() {
    	fileUploadPhotosVideos.enterFolderName(folderName);
    }
    ...
    public void user_should_see_the_successfully_added_message() {
        Assert.assertTrue(fileUploadPhotosVideos.isPopUpSuccessWindowVisible());
    }
    ...
    public void User_clicks_the_added_folder() {
    	fileUploadPhotosVideos.clickOnAddedFolder(folderName);
    }
